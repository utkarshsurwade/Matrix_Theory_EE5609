...
\begin{abstract}
This document contains the solution to finding the point at which the respective line is tangent to the curve
\end{abstract}
...
%
\begin{lstlisting}
https://github.com/utkarshsurwade/Matrix_Theory_EE5609/tree/master/Assignment6
\end{lstlisting}
%
\section{Problem}
Find the point at which the line $\myvec{-1 & 1}\vec{x}=1$\\
...
\end{align} 
\begin{align}
\therefore\vec{u} = \myvec{d\\e} = \myvec{-2\\0}\label{u}
\end{align}
\begin{align}
...
\begin{align}
    ...
    \therefore \vec{n} = \myvec{1\\-1}\label{n}
\end{align} 
...
\mbox{where, } \kappa = \frac{\vec{p_1}^T\vec{u}}{\vec{p_1}^T\vec{n}} = -2 \label{k}
\end{align}
