...
\begin{abstract}
This document contains the solution to find the inverse of matrix,if it exists 
\end{abstract}
...
%
\begin{lstlisting}
https://github.com/utkarshsurwade/Matrix_Theory_EE5609/tree/master/Assignment2
\end{lstlisting}
%
\section{Problem}
Using elementary transformations, find the inverse of the matrix,if it exists
\begin{align}
		\myvec{1 & 3 & -2\\-3 & 0 & -5\\2 & 5 & 0\\}
\end{align}
\section{Solution}
\begin{flushleft}
\begin{align}
