...
$\therefore (AB)^2 = (AC)^2$\\
\begin{align}
\therefore\vec{(A-B)}^2 = \vec{(A-C)}^2
\end{align}
\begin{multline}
\vec{(A-B)}^2+\frac{1}{4}\vec{(A-C)}^2 -\vec{(A-C)}^T\vec{(A-B)} =\\
\vec{(A-C)}^2+\frac{1}{4}\vec{(A-B)}^2 -\vec{(A-B)}^T\vec{(A-C)}
\end{multline}
\begin{align}
(\frac{1}{2}\vec{(A-C)}-\vec{(A-B)})^2 &= (\frac{1}{2}\vec{(A-B)}-\vec{(A-C)})^2\\
\vec{(B-F)}^2 &= \vec{(C-E)}^2\\
\therefore\norm{\vec{B-F}} &= \norm{\vec{C-E}}
\end{align}
