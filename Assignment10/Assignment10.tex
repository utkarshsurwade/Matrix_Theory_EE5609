...
%
\begin{lstlisting}
https://github.com/utkarshsurwade/Matrix_Theory_EE5609/tree/master/Assignment10
\end{lstlisting}
%
\section{\textbf{Problem}}
Let $\vec{V}$ be the set of all 2 X 2 matrices $\vec{A}$ with complex entries which satisfy $ \vec{A_{11}} + \vec{A_{22}}$ = 0 and Show that $\vec{V}$ is a vector space over the field of real numbers, with the
