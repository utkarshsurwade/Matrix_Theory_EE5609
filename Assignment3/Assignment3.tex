...
\begin{abstract}
This document contains the solution to find the determinant of a matrix using properites of determinants 
\end{abstract}
...
%
\begin{lstlisting}
https://github.com/utkarshsurwade/Matrix_Theory_EE5609/tree/master/Assignment3
\end{lstlisting}
%
\section{Problem}
By Using properties of determinants,show that
\begin{align}
    \mydet{x+4 & 2x & 2x \\ 2x & x+4 & 2x \\ 2x & 2x & x+4} = (5x+4)(4-x)^2
\end{align}
\section{Solution}
\begin{flushleft}
\begin{align}
